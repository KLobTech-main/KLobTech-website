      ...
      <div className="py-2 ">
        ...
        <div>
          <button
            ...
            className="flex w-full text-start px-16 pb-4 text-gray-700 hover:bg-[#f3f3f3] transition-colors duration-150 text-[2rem] items-center"
          >
            Services
            <span
              style={{
          ...
          <div
            ...
            className={`rounded-3xl text-[1.5rem] px-4 py-4 bg-[#f3f3f3] transform transition-all duration-300 ease-in-out ${
              activeMenu === "services"
