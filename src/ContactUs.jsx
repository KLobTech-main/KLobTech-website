...
function ContactUs() {
  const contactMethods = [
    {
      ...
      address: "mailto:info@klobtech.com?subject=Inquiry&body=Hello, I would like to know more about your work...",
    },
    {
      icon: <Phone className="w-10 h-10 md:w-12 md:h-12" />,
      title: "Call Us",
    ...
    },
    {
      ...
      title: "Visit Our HQ",
      content: "H-248c, Riico Ind. Area, Road No. 2. Mansarovar, Jaipur, Rajasthan, India",
    ...
    },
    {
      ...
      content: "5th Floor, Jaipur Electronic Market, Near Riddhi Siddhi Circle, Gopalpura Bypass Road,\nJaipur, Rajasthan, India 302018",
      subtext: "Get directions on Google Maps",
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 p-10 sm:p-16 lg:p-24">
        <main className="max-w-[120rem] mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-6 sm:gap-12 lg:gap-14">
            {contactMethods.map((method, index) => (
              <a href={method.address} target="_blank" key={index} className="block">
                <div
                ...
                >
                  ...
                  <p className="text-base sm:text-lg text-gray-500">{method.subtext}</p>
                </div>
              </a>
            ))}
          </div>
